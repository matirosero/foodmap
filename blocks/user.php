		<div id="user" class="global-container">



<!-- CODIGO DE PAGINA PERFIL USUARIO EMPIEZA AQUI -->
...
<div class="user-content">
	...
	<div id="user-actions">
		...
		<div id="user-main-header">
			<h2><strong>MIS FOOD</strong>TRIPS </h2>
		</div>

		<div id="user-main-content">
			<ul>
				<li>
					<div class="user-foodtrip-new">
						<div class="user-foodtrip-image">
							<img src="images/user-new-foodtrip-thumb.jpg" alt="Nuevo FoodTrip">
						</div>
				...
				<h3><strong>FOOD</strong>TRIPS<strong> PREMIUM</strong>
				<span class="user-tips">¡Te quedan 4 FoodTrips <span style="color: #eb4b3f"> GRATIS!</span></span>
				</h3>
				<li>
					<div class="user-foodtrip-item">
						...
						<div class="user-foodtrip-description">
							...
							<p><strong>CONTENIDO</strong> Creado por La BulliFoundation <br/ >
								Explicaciones de Ferrán Adrià <br />
								15 platos locales con recetas de ElBulli<br />
								20 productos locales<br />
							</p>
						</div>
					...
					<h3><strong>MIS FOOD</strong>TRIPS</h3>
				<li>
					<div class="user-foodtrip-item">
						<div class="user-foodtrip-image">
				...
				<li>
					<div class="user-foodtrip-item">
						...
						<div class="user-foodtrip-description">
							...
							<p><strong>CONTENIDO</strong> Creado por mí <br/ >
							3 Regiones <br />
							15 platos  <br />
							10 productos <br />
							</p>
...
<!-- CODIGO DE PAGINA PERFIL USUARIO TERMINA AQUI -->
