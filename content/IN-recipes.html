				<header id="sidepanel-header">
					...
					<p>
						hiiii Consectetur adipiscing elit. Etiam viverra dolor id enim venenatis hendrerit. Donec faucibus urna vitae lorem viverra rutrum. Fusce vehicula est at velit scelerisque commodo. Pellentesque lorem ligula, aliquam ut placerat ut, placerat at enim.
					</p>
				</header>
				...
				<div id="sidepanel-results">
					...
					<ul class="blocks">
						...
						<li>
							<a class="foodresult-link" href="#IN-bhakri" data-sidepanel-content="bhakri" data-country-code="IN">
